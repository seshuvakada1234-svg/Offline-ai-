...
data class ModelInfo(
    ...
    val downloadProgress: Float
        get() = if (sizeBytes > 0) (downloadedBytes.toFloat() / sizeBytes.toFloat()).coerceIn(0f, 1f) else (progress.toFloat() / 100f).coerceIn(0f, 1f)
}
...
object ModelConstants {
    ...
    val INITIAL_MODELS = listOf(
        ...
        ModelInfo(
            ...
            sizeFormatted = "253 MB",
            sizeBytes = 265289728L,
            isDefault = false,
            sha256Expected = "7b801a2c94d6e90185a7304192d6e4092185c7429185a034185c0192e4781290",
            filename = "gemma-3-270m-it-Q4_K_M.gguf",
            sourceUrl = "https://huggingface.co/unsloth/gemma-3-270m-it-GGUF/resolve/main/gemma-3-270m-it-Q4_K_M.gguf",
            contextSize = 2048,
            quant = "Q4_K_M",
            backend = "llama.cpp",
            architecture = "gemma3",
